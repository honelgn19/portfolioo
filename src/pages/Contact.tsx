...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert("Thank you! Your message has been received. (Demo Form)");
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-4 text-white placeholder-gray-500 focus:outline-none focus:border-[#C0C0C0]/50 transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full bg-white/5 border border-white/10 rounded-3xl px-5 py-4 text-white placeholder-gray-500 focus:outline-none focus:border-[#C0C0C0]/50 transition-colors resize-y min-h-[140px]"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full mt-4 bg-[#C0C0C0] hover:bg-white text-black font-semibold py-4 rounded-2xl flex items-center justify-center gap-3 transition-all duration-300"
                >
                  <Send size={20} />
                  Send Message
                </motion.button>
